...
export const adminKey = import.meta.env.VITE_ADMIN_API_KEY || "change-me-dev-admin-key";
...
export const friendlyError = (error) =>
  friendly[error?.code] || error?.message || "Request failed. Please try again.";
...
export function buildHeaders({
  ...
  if (admin && adminApiKey) headers["X-Admin-API-Key"] = adminApiKey;
