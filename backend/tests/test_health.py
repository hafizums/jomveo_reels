...
def test_public_route_contract_is_preserved() -> None:
    ...
    assert {
        ...
        "/api/projects/{project_id}/billing/transactions",
        "/api/projects/{project_id}/billing/usage",
        "/api/projects/{project_id}/billing/top-up",
        "/api/projects/{project_id}/billing/reconcile",
        "/api/projects/{project_id}/quotas",
